...
return [
	...
	'home' => [
		...
		"by_clicking" =>  "By clicking on “Book Now”, you agree to Adriana Travel’s",
		"by_clicking_send" =>  "By clicking on “Send”, you agree to Adriana Travel’s",
		...
		"planing_a" =>  "Planning a",
		"dalmatia" =>  "Dalmatia",
		"getaway" =>  "getaway?",
		"subscription" =>  "Thank You for your subscription!",
		"subscribe" =>  "Subscribe",
		"email_required" =>  "Email is required",
		"tips" =>  "Get our tips and top offers straight to your inbox!",
		"infants" => "Infants and pets don’t counttowards the number of guests.",
		"thank_you_payment" => "Thank You for your payment!",


		//iznad dat vanni za prevest
		'lang' => 'en',
		'based' => 'Based on',
		'where_are_we' => ' Where are we?',
		'or' => 'or',
		'by' => 'By',
		'looking_best' => '  Looking for the best place to stay?',
		'minimise_the_hassle' => 'Minimise the hassle, maximise the holiday',
		'a_click_away' => 'You are just a click away from your perfect holiday in Dalmatia',
		'stress_free_dalmatia' => 'Enjoyable and stress-free Dalmatia',
		'whether_you_prefer' => 'Whether you prefer privacy of luxury villas or cosiness of
		little apartments, adventure packed itineraries or slow paced
		relaxing experiences, we are here to cater them all.',
		'where_to_stay' => 'Where to stay',
		'villas' => 'Villas',
		'apartments' => 'Apartments',
		'our_favourites' => 'Our Favourites',
		'homes' => 'Homes',
		'a_lot_more' => 'We have a lot more beautiful homes we think you’ll love.',
		'discover' => 'Discover',
		'services' => 'Services',
		'discover_rogoznica' => 'Discover Rogoznica',
		'tailor_made_experience' => 'Looking for a tailor-made Dalmatia experience? We are offering you a wide range of services and activities to choose from.',
		'blog' => 'Blog',
		'read_more' => 'read more',
		'read_morecaps' => 'READ MORE',
		'beating_heart' => 'Dalmatia’s beating heart Rogoznica',
		'epicenter' => ' is an unmistakable inauguration point and an epicentre of
		your custom Adriatic experience!',
		'stays' => 'Stays',
	...
	'header' => [
		...
		'explore_dalmatia' => 'Explore Dalmatia',
		'impressum' => 'Impressum',
		'all_rights_reserved' => 'Copyright 2022. All rights reserved.',
		'vuerogoznica' => "We're sorry but vuerogoznica doesn't work properly without JavaScript enabled. Please enable it to
			continue.",
		'on' => 'on',
		'off' => 'off',
	...
	'footer' => [
		...
		'using_cookies' => ':site_name uses cookies to improve user experience. By using our website you consent to our cookies in accordance with our',
	],
	...
	'transfers' => [
		'transfers' => 'Transfers',
		'vw' => 'Transfer with air-conditioned van',
		'airport_apartment' => 'Transfer from airport to apartment',
		'airport_split' => 'Airport - Split',
		'airport_zadar' => 'Airport - Zadar',
		'per_person' => 'per Person',
		'children_free' => 'children up to 10 years free of charge',
	...
	'lys' => [
		...
		'interaction_with_guests' => 'Distance from Sea',
	...
	'services-activities' => [
		...
		'rent_a_boat_1' => 'Rent a boat one ',
		'rent_a_boat_2' => 'Rent a boat two',
		'per_day' => 'per day',
		'half_day' => 'half day',
		'july_august' => 'July / August',
		'june_september' => 'June / September',
		'may_october' => 'May / October',
		...
		'rent_a_boat_desc' => 'Want to avoid the summer temperatures and the crowds of tourists? Rent a boat at a special price and sail away!',
	...
	'rogoznica' => [
		'heart_dalmatia' => 'Welcome to the very heart of Dalmatia',
		'mediterranean' => 'Where Mediterranean way of life is still very much alive',
		'where' => 'Where is it?',
		'where_desc' => "Located in a deep bay sheltered from the wind, a small town of
			Rogoznica and its 50 km long unspoiled coast is a nautical
			heaven rich with ideal climate, stunning beaches, shadowy pine
			forests and natural phenomenon salt water lake Dragon's Eye with
			a distinctive flora and fauna.",
		'where_desc_2' => '   A quiet and warm town centre where mediterranean way of life is
			still very alive, is brimming with the old stone houses placed
			above a palm-filled promenade. There is plenty of history rooted in its streets and sacred
			buildings as well as myths and legends yearning to be explored.',
		'how' => 'How to get there?',
		'how_desc' => 'Due to proximity of the airports (25 km from Split airport, 110
			km from Zadar airport) and the A1 highway, Rogoznica is easily
			reachable regardless what type of transport you prefer.',
		'how_desc_2' => '      With award winning Marina Frapa, considered one the most
			beautiful on the Adriatic, and vicinity of ferry lines and bus
			routes connecting all main Dalmatian destinations, Rogoznica is
			also a perfect jumping-off point for various excursions and day
			trips into the region, up north from Plitvice National Park,
			down south all the way to Dubrovnik.',
		'sum_all' => 'To sum it all, Dalmatia’s beating heart Rogoznica is an
			unmistakeable inauguration point and an epicentre of your custom
			Adriatic experience!',
	...
	'explore' => [
		'4per' => '4 Persons',
		'5per-more' => '5 Persons and more',
		'for_all_rides' => 'We are aware that you may have specific travel requirements.  For more minivan tours, 
		feel free to contact us. ',
		'return_ride' => 'Return ride',
		'million-travellers' => 'Because millions of travellers can’t be wrong',
		'check' => ' Check why Dalmatia deserves the top spot on your bucket list',
		'dazzling' => 'Dazzling coastline with thousand islands, prised beaches and
			centuries old harbour towns with impressive architecture are just
			a few assets of Dalmatia that inspire millions of travellers every
			year.',
		'stretching' => 'Stretching from Zadar in the north to Dubrovnik in the south, this
			diverse region also takes pride in the unspoilt nature, rich
			culture and delicious mediterranean cuisine.',
		'ready' => 'Ready for a great time? Take a closer look at the Dalmatian great
			four!',
		'sibenik' => 'Šibenik',
		'sibenik_desc01' => 'The oldest coastal town in Croatia, royal Šibenik will stun
			you with its medieval charm and relaxed atmosphere.',
		'sibenik_desc02' => ' With evocative Old Town, historic churches, busy seafront
			lined with restaurant and bars, cool music festivals,
			attractive beaches and idilic hinterland, it offers heaps of
			history, culture and fun. Definitely worth your time and
			attention!',
		'sibenik_desc03' => '     While in Šibenik, admire the one of the most significant
			architectural achievements in Croatia - monumental St. James
			Cathedral; check out the breathtaking views from Šibenik’s
			proud sea guardian St. Nicholas Fortress; study the
			medicinal and spicy herbs of Mediterranean Monastery Garden
			of St. Lawrence and make sure to take home highly valued
			ecological sponge of Krapanj as a souvenir.',
		'sibenik_worth' => 'Worth the visit in Šibenik region:',
		'st_james' => 'Cathedral of St. James',
		'st_nicholas' => "St. Nicholas' Fortress",
		'krka' => 'Krka National Park',

		'kornati' => 'Kornati National Park',
		'trogir' => 'Trogir',
		'split' => 'Split',
		'split_desc01' => 'Settled between imposing mountains and the sea bay dotted
			with strikingly beautiful islands, the second largest
			Croatian city Split is a tourist hotspot that offers a mix
			of impressive history and hedonistic lifestyle.',
		'split_desc02' => ' ',
		'split_desc03' => '',
		'split_worth' => 'Worth the visit in Šibenik region:',
		'st_james' => 'Cathedral of St. James',
		'st_nicholas' => "St. Nicholas' Fortress",
		'kornati' => 'Kornati National Park',
		'split' => 'Split',
		'split_desc01' => 'Settled between imposing mountains and the sea bay dotted
			...
			Croatian city Split is a tourist hotspot that offers a mix
			of impressive history and hedonistic lifestyle.',
		'split_desc02' => 'Filled with ancient monuments, stylish restaurants and
			eclectic boutiques, it will give you a true Mediterranean
			Riviera feel. While in Split, visit the extravagant
			Diocletian’s Palace - one of the best preserved monuments of
			the Roman architecture in the world; climb The Cathedral of
			St. Domnius for an exceptional view of the city; enjoy the
			coffee at busy Riva promenade; soak up the sun at famous
			Bačvice beach and, if you get tired of the city buzz, take a
			hike on Marjan hill that overlooks Split.',
		'split_worth' => 'Worth the visit in Split region:',
		'diocletian' => 'Diocletian Palace and Peristyle',
		'klis' => 'Cathedral of St Dominus',
		'st_dominus' => 'Klis Fortress',
		'blue_cave' => 'Blue Cave on Bisevo Island',
		'zadar' => 'Zadar',
		'zadar_desc01' => 'Zadar will enchant you with its cobblestone streets and historical landmarks by day, and lively bars and restaurants by night. And did we mention the the otherworldly sunsets?
		Along with a great variety of beaches and many natural and national parks in the vicinity, it’s no wonder Zadar is a go-to destination for visitors of all ages.',
		'zadar_desc02' => 'While in Zadar, visit the the 27m high and 22m wide church of St. Donatus; grab an ice cream and take a walk on the main street Kalelarga; listen to the music created by the one of a kind Sea Organ; enjoy the light show made by a solar powered installation ‘Greeting to the Sun’, and taste the original liquor Maraschino made from an autochthonous variety of cherry.',
		'zadar_worth' => 'Worth the visit in Zadar region:',
		'st_donatus' => 'Church of St. Donatus',
		'sea_organ' => 'Sea Organ and Greeting to the Sun',
		'paklenica' => 'National Park Paklenica',
		'pag' => 'Pag Island',
		'dubrovnik' => 'Dubrovnik',
		'dubrovnik_desc01' => 'The southernmost of the four cities, Dubrovnik is dubbed as
			the Pearl of the Adriatic for so many reasons.',
		'dubrovnik_desc02' => 'Renowned worldwide and beloved for its stunning seaside
			location, heart-stopping beauty of the historic old town and
			numerous fine dining restaurants, majestic Dubrovnik is one
			of those places you may never want to leave.',
		'dubrovnik_desc03' => 'While in Dubrovnik, tour the spectacular medieval city walls
			and forts that run around 2 kilometres around the old city;
			head down the famous limestone paved main city promenade
			Stradun and explore old town; take a cable car ride to the
			top of the Srđ mountain with the most magnificent view of
			Dubrovnik and relax at the Dubrovnik’s most popular beach
			Banje.',
		'dubrovnik_worth' => 'Worth the visit in Dubrovnik region:',
		'walls' => 'City Walls and Forts',
		'old_town' => 'Old Town',
	...
	'rooms' => [
		...
		'error_msg'=>'This Date Already Booked Please Select Another Date',
	...
	'payments' => [
		...
		'car' => 'Rent-a-Car',
		'transfer' => 'Need a Transfer?',
		'anchor' => 'Lower the anchor and have a nice vaccation!',
		'you_did' => 'You did it!',
		'almost_there' => 'You are almost there...',
		'confirmation_ready_next' => 'Your confirmation will be ready within the next 24 hours.',

		'extra_holiday_services' => 'While you are waiting, explore our extra holiday services and activities.',
		'for' => 'for',
		'to' => 'to',
	...
	'feedback' => [
		...
		'email' => 'Email',
		'feedback' => 'Feedback',
		'feedback_sent_successfully' => 'Feedback has been successfully sent',
		'send' => 'Send',
		'overall_rating' => 'Overall rating',
		'compliance_of_the_boat' => 'Compliance of the boat',
		'comfort_on_board' => 'Comfort on board',
		'standard_of_maintenance' => 'Standard of maintenance',
		'cleanliness' => 'Cleanliness',
		'welcome_and_communication' => 'Welcome and communication',
