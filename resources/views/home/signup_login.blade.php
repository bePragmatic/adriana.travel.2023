  ...
  <div class="container py-4 py-md-5">
    <div class="log-page p-4">
      <ul class="social-log">
        ...
        {{--
        <li>
          <a href="{{ url('auth/linkedin')}}" class="linkedin-btn btn d-flex align-items-center
      ...
      <ul class="social-log">
        <li>
          ...
          <a href="{{ $fb_url }}" class="email-btn btn d-flex align-items-center justify-content-center"
            data-toggle="modal" data-target="#signup-popup2">
