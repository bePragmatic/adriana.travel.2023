...
<div class="panel-padding panel-body pad-25">
  ...
  <div class="social-buttons hide">
    ...
    <a href="{{ $fb_url }}" class="fb-button fb-blue btn icon-btn btn-block row-space-1 btn-large btn-facebook"
    ...
    {{--
            <a href="{{URL::to('auth/linkedin')}}" class="li-button li-blue btn icon-btn btn-block btn-large
    row-space-1 btn-linkedin">
    <span class="icon-container">
    ...
    {{-- </div>
            ...
            <div class="text-center social-links">
              <a href="{{ $fb_url }}"
    class="fb-button fb-blue btn icon-btn btn-block row-space-1 btn-large btn-facebook"> <span class="icon-container">
      <i class="icon icon-facebook"></i>
    </span>
    <span class="text-container">
      {{ trans('messages.login.signup_with') }} Facebook
    </span></a>
    <a href="{{URL::to('googleLogin')}}" class="btn icon-btn btn-block row-space-1 btn-large btn-google"><span
    ...
    <a href="{{URL::to('auth/linkedin')}}"
      class="li-button li-blue btn icon-btn btn-block btn-large row-space-1 btn-linkedin">
      <span class="icon-container">
        <i class="icon icon-linkedin"></i>
      </span>
      <span class="text-container">
  ...
  <div class="text-center">
    <a href="{{URL::to('/')}}/signup_login?sm=2" class="create-using-email btn-block  row-space-2  icon-btn hide"
  ...
  'id' => 'user_new', 'accept-charset' => 'UTF-8' , 'novalidate' => 'true']) !!}
  ...
  <div class="signup-form-fields">
    ...
    <div class="control-group row-space-1" id="inputFirst">
      ...
      'decorative-input name-icon', 'placeholder' => trans('messages.login.first_name')]) !!}
    ...
    <div class="control-group row-space-1" id="inputLast">
      ...
      inspectletIgnore invalid' : 'decorative-input inspectletIgnore name-icon', 'placeholder' =>
    ...
    <div class="control-group row-space-1" id="inputEmail">
      ...
      invalid' : 'decorative-input inspectletIgnore name-mail name-icon', 'placeholder' =>
    ...
    <div class="control-group row-space-1" id="inputPassword">
      ...
      invalid' : 'decorative-input inspectletIgnore name-pwd name-icon', 'placeholder' =>
    ...
    <div class="control-group row-space-top-3 row-space-1">
      ...
      <strong data-behavior="tooltip"
        ...
        <div class="tooltip-amenity tooltip-amenity2 tooltip-bottom-middle" data-sticky="true" aria-hidden="true"
          style="left: -63px;top: -108px;">
          <dl class="panel-body">
    ...
    @if ($errors->has('birthday_month') || $errors->has('birthday_day') || $errors->has('birthday_year')) <p
      class="help-block">
...
{{-- </label> --> --}}
 ...
 I’d like to receive coupons and inspiration
    ...
    {{-- <div id="tos_outside" class="row-space-top-3 chk-box">
      ...
      href="{{URL::to('/')}}/terms_of_service" data-popup="true">{{ trans('messages.login.terms_service') }}</a>, <a
      href="{{URL::to('/')}}/privacy_policy" data-popup="true">{{ trans('messages.login.privacy_policy') }}</a>, <a
      href="{{URL::to('/')}}/guest_refund" data-popup="true">{{ trans('messages.login.guest_policy') }}</a>,
    {{ trans('messages.header.and') }}
    <a href="{{URL::to('/')}}/host_guarantee" data-popup="true">{{ trans('messages.login.host_guarantee') }}</a>.
    </small>

  </div>

</div>
{!! Form::submit('Sign up', ['class' => 'btn btn-primary btn-block btn-large pad-top' , 'id' =>
'user-signup-btn']) !!}
{!! Form::close() !!}
</div>
...
<div class="panel-body font-small bottom-panel">
  ...
  <a href="{{ url('login') }}" class="modal-link link-to-login-in-signup login-btn login_popup_head"
