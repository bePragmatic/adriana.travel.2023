<div class="col-lg-2 col-md-3 manage-nav p-0" id="js-manage-listing-nav">
  <div class="nav-sections">
    ...
    <ul class="list-unstyled list-nav-link">
      <li class="nav-item nav-padding-0 nav-calendar pre-listed padding-top-0-imp" data-track="calendar"
      ...
      <li class="nav-item nav-padding-0 nav-pricing pre-listed padding-top-0-imp" data-track="pricing"
        ...
        <a href="{{ ($room_step != 'pricing') ? url('manage-listing/'.$room_id.'/pricing') : '' }}" id="href_pricing">
          ...
          @if($result->status == NULL)
          <div
            class="js-new-section-icon not-post-listed transition {{ ($rooms_status->pricing == 1) ? 'd-none' : 'visible' }}">
      ...
      <li data-track="how-guests-book" class="nav-item nav-padding-0 pre-listed padding-top-0-imp"
        ...
        <a href="{{ ($room_step != 'booking') ? url('manage-listing/'.$room_id.'/booking') : '' }}" id="href_booking">
          ...
          <div>
            <i aria-hidden="true"
              class="icon nav-icon-checked not-post-listed icon-ok-alt {{ ($rooms_status->booking == 1) ? '' : 'd-none' }}">
            </i>
            <i class="dot dot-success d-none"></i>
          </div>
          @endif
    ...
    <ul class="list-unstyled list-nav-link">
      <li class="nav-item nav-padding-0 nav-basics pre-listed padding-top-0-imp" data-track="basics"
        ...
        <a href="{{ ($room_step != 'basics') ? url('manage-listing/'.$room_id.'/basics') : '' }}" id="href_basics"
          ...
          @if($result->status == NULL)
          <div
            class="js-new-section-icon not-post-listed transition {{ ($rooms_status->basics == 1) ? 'd-none' : 'visible' }}">
            <i class="icon icon-add"></i>
          </div>
          <div class="success-icon">
      ...
      <li class="nav-item nav-padding-0 nav-description pre-listed padding-top-0-imp" data-track="description"
        ...
        <a href="{{ ($room_step != 'description') ? url('manage-listing/'.$room_id.'/description') : '' }}"
          ...
          @if($result->status == NULL)
          <div
            class="js-new-section-icon not-post-listed transition {{ ($rooms_status->description == 1) ? 'd-none' : 'visible' }}">
            <i class="icon icon-add"></i>
          </div>
          <div class="success-icon">
      ...
      <li class="nav-item nav-padding-0 nav-location pre-listed padding-top-0-imp" data-track="location"
        ...
        <a href="{{ ($room_step != 'location') ? url('manage-listing/'.$room_id.'/location') : '' }}"
          ...
          @if($result->status == NULL)
          <div
            class="js-new-section-icon not-post-listed transition {{ ($rooms_status->location == 1) ? 'd-none' : 'visible' }}">
            <i class="icon icon-add"></i>
          </div>
          <div class="success-icon">
      ...
      <li class="nav-item nav-padding-0 nav-amenities pre-listed padding-top-0-imp" data-track="amenities"
        ng-class="(step == 'amenities') ? 'nav-active' : ''">
        <a ng-click="reloadRoute()"
          href="{{ ($room_step != 'amenities') ? url('manage-listing/'.$room_id.'/amenities') : '' }}"
          id="href_amenities">
          <span class="text-truncate">
      ...
      <li class="nav-item nav-padding-0 nav-photos pre-listed padding-top-0-imp" data-track="photos"
        ...
        <a href="{{ ($room_step != 'photos') ? url('manage-listing/'.$room_id.'/photos') : '' }}" id="href_photos">
          ...
          @if($result->status == NULL)
          <div
            class="js-new-section-icon not-post-listed transition {{ ($rooms_status->photos == 1) ? 'd-none' : 'visible' }}">
            <i class="icon icon-add"></i>
          </div>
          <div class="success-icon">
      ...
      <li class="nav-item nav-padding-0 nav-video pre-listed padding-top-0-imp" data-track="video"
        ng-class="(step == 'video') ? 'nav-active' : ''">
    ...
    <ul class="list-unstyled list-nav-link">
      <li class="nav-item nav-padding-0 nav-details pre-listed padding-top-0-imp" data-track="details"
      ...
      <li class="nav-item nav-padding-0 nav-terms pre-listed padding-top-0-imp" data-track="terms"
    ...
    <ul class="list-unstyled list-nav-link">
      ...
      <li class="nav-item nav-padding-0 nav-calendar pre-listed padding-top-0-imp" id="remove-manage"
        data-track="calendar" ng-class="(step == 'calendar') ? 'nav-active' : ''">
        <a href="{{ ($room_step != 'calendar') ? url('manage-listing/'.$room_id.'/calendar') : '' }}"
          id="href_calendar">
          <span class="text-truncate">
            {{ trans('messages.lys.calendar') }}
  ...
  <div class="publish-actions text-center"
    ng-init="steps_count={{ $result->steps_count }};status='{{ $result->status }}'">
    <div id="user-suspended"></div>
    <div id="availability-dropdown" class="availability-dropdown-wrap d-flex align-items-center justify-content-center"
      ng-if="status && status != 'Pending' && steps_count == 0">
    ...
    <div id="js-publish-button" ng-if="(! status) || status == 'Pending' || (status == 'Unlisted' && steps_count != 0)">
      <div class="not-post-listed text-center">
        ...
        <span data-href="complete" class="green-color" id="js-list-space-button1"
          data-track="list_space_button_left_nav" ng-show="steps_count==0">
