...
--}}
  ...
  <div id="js-weekend-pricing" class="mt-2 js-tooltip-trigger">
        ...
        <div class="row">
          <div class="col-md-12 mt-3 p-0" ng-repeat="item in length_of_stay_items">
            <div class="length_whole w-100 d-md-flex">
              ...
              <div class="col-12 col-md-5 pricing_field mt-3 mt-md-0">
                <button href="javascript:void(0)" class="delete_length" id="js-length_of_stay-rm-btn-@{{$index}}" ng-click="remove_price_rule('length_of_stay', $index)">
   ...
   {{--  TODO: ZAKOMENNTIRANO  <div class="early-bird-content js-section {{ ($result->status != NULL) ? 'pre-listed' : 'post-listed' }}">
        ...
        <div class="col-md-12 p-0" ng-repeat="item in early_bird_items">
          <div class="row">
            ...
            <div class="col-12 col-md-2 pricing_field_list mt-3 mt-md-0">
              <button href="javascript:void(0)" class="delete_length" id="js-early_bird-rm-btn-@{{$index}}" ng-click="remove_price_rule('early_bird', $index)">
                <span class="icon icon-trash"></span>
              </button>
            </div>
          </div>
  ...
  {{--  TODO: ZAKOMENNTIRANO <div class="last-min-content js-section {{ ($result->status != NULL) ? 'pre-listed' : 'post-listed' }}">
    ...
    <div id="js-last_min_wrapper" class="mt-3 last-min-wrap js-tooltip-trigger" ng-init="last_min_items = {{json_encode($result->last_min_rules)}}; lm_errors= [];">
      <div class="col-md-12 p-0" ng-repeat="item in last_min_items">
        ...
        <div class="col-12 col-md-2 pricing_field_list mt-3 mt-md-0">
          <button href="javascript:void(0)" class="delete_length" id="js-last_min-rm-btn-@{{$index}}" ng-click="remove_price_rule('last_min', $index)">
            <span class="icon icon-trash"></span>
          </button>
        </div>
      </div>
