...
<main id="site-content" role="main">    
        ...
        <div class="col-12 col-md-9"> 
          ...
          <div class="card card-additional-padding--right">
            ...
            <div id="accept_decline" class="card-body">
              <div class="table-responsive padding__right--0">
            ...
            <!-- user info -->
            <div class="card card-additional-padding--right mt-3">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-12 col-md-4 profile-img-reservation user-reserve text-center text-md-left">
                  <img class="mb-4 reservation-profile" alt="{{ $result->users->first_name }}" src="{{ $result->users->profile_picture->src }}" title="{{ $result->users->first_name }}">
                  <p class="username-reservation">
            ...
            <div class="py-3 px-4">
              <p class="m-0 reservation-mobile-center">
                {{ trans('messages.your_reservations.penalized_if_expires') }}
              </p>
            </div>

            <div class="card-footer card-footer-guest reservation-text-right pt-4">
  ...
  <div class="modal" role="dialog" id="accept-modal" aria-hidden="true" tabindex="-1">
   <div class="modal-dialog" role="document">
    <div class="modal-content border-radius--24 p-3 outline-border--none">
      ...
      <form accept-charset="UTF-8" action="{{ url('reservation/accept/'.$reservation_id) }}" id="accept_reservation_form" method="post" name="accept_reservation_form">
        ...
        <div class="modal-body">
          ...
          <textarea cols="40" id="accept_message" name="message" rows="10" class="img-fluid"></textarea>
