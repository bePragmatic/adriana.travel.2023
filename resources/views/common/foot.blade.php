...
<script type="text/javascript"
  src="https://maps.googleapis.com/maps/api/js?key={{ $map_key }}&libraries=places&language={{ (Session::get('language')) ? Session::get('language') : $default_language[0]->value }}">
</script>

<script>
  window.wspay_uri = "{{ config('wspay.wspay_uri') }}"
</script>
...
@if (Route::current()->uri() == 'wishlists/popular' || Route::current()->uri() == 'wishlists/my' ||
Route::current()->uri() == 'wishlists/picks' || Route::current()->uri() == 'wishlists/{id}' || Route::current()->uri()
== 'users/{id}/wishlists')
{!! Html::script('js/wishlists.js?v='.$version) !!}
{!! Html::script('js/home_two.js?v='.$version) !!}
@endif

@if (Route::current()->uri() == 'inbox' || Route::current()->uri() == 'z/q/{id}' || Route::current()->uri() ==
'messaging/qt_with/{id}')
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <ul class="social-log">
          ...
          <li>
            <a href="javascript:;" id="pop_google_login"
              class="google-btn btn d-flex align-items-center justify-content-center">
              <i class="icon icon-google-plus"></i>
              <span class="d-inline-block ml-3">
                {{ trans('messages.login.login_with')}} testeszt
              </span>
            </a>
          </li>
          <li>
        ...
        <div class="log-form">
          {!! Form::open(['url' => route('login'), 'method' => 'POST', 'novalidate' => 'true', 'data-action' =>
          'Signin']) !!}
          ...
          <div class="control-group">
            ...
            <div class="d-flex align-items-center">
              <input
                class="{{ $errors->has('email') ? 'decorative-input inspectletIgnore invalid' : 'decorative-input inspectletIgnore name-icon' }}"
                placeholder="{{ trans('messages.login.email_address') }}" id="signin_email" name="login_email"
                type="email" value="">
          ...
          <div class="control-group">
            ...
            <div class="d-flex align-items-center">
              <input
                class="{{ $errors->has('password') ? 'decorative-input inspectletIgnore invalid' : 'decorative-input inspectletIgnore name-icon' }}"
                placeholder="{{ trans('messages.login.password') }}" id="signin_password" data-hook="signin_password"
        ...
        <div class="log-form">
          ...
          <div class="control-group">
            ...
            <div class="input-group">
              {!! Form::email('email', '', ['placeholder' => trans('messages.login.email'), 'id' => 'forgot_email',
              'class' => $errors->has('email') ? 'decorative-input inspectletIgnore invalid input_new' :
              'decorative-input inspectletIgnore input_new']) !!}
              <i class="icon icon-envelope"></i>
            </div>
          </div>
          <div class="d-flex mt-4 align-items-center justify-content-between">
            <a href="javascript:void(0)" class="back-btn d-flex align-items-center" data-toggle="modal"
              data-target="#forgot-popup">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <i class="icon icon-facebook"></i>
        <span class="d-inline-block ml-3">
          {{ trans('messages.login.signup_with')}} Facebookt2gb
        </span>
        </a>
        </li>
        <li>
          <a href="javascript:void(0);" id="pop_google_signup_login"
            class="google-btn btn d-flex align-items-center justify-content-center">
            <i class="icon icon-google-plus"></i>
            <span class="d-inline-block ml-3">
        ...
        <li>
          <a href="{{ getAppleLoginUrl() }}" id="apple_login"
            ...
            <i class="fa fa-apple push-half--right"></i>
            <span class="d-inline-block ml-3">
              {{ trans('messages.login.signup_with')}} Edo tets
            </span>
          </a>
        </li>
        {{--
      ...
      {{-- <ul class="social-log">
        <li> --}}
      <a href="{{ $fb_url }}" class="email-btn btn d-flex align-items-center justify-content-center" data-toggle="modal"
        data-target="#signup-popup">test
        <i class="icon icon-envelope"></i>
        <span class="d-inline-block ml-3">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="log-form">
          {!! Form::open(['action' => 'UserController@create', 'class' => 'signup-form', 'data-action' => 'Signup', 'id'
          ...
          <div class="signup-form-fields">
            ...
            <div class="control-group" id="inputFirst">
              ...
              <div class="d-flex align-items-center justify-content-center">
                ...
                'decorative-input name-icon input_new', 'placeholder' => trans('messages.login.first_name')]) !!}
            ...
            <div class="control-group" id="inputLast">
              ...
              <div class="d-flex align-items-center justify-content-center">
                ...
                inspectletIgnore invalid' : 'decorative-input inspectletIgnore name-icon input_new', 'placeholder' =>
            ...
            <div class="control-group" id="inputEmail">
              ...
              <div class="d-flex align-items-center justify-content-center">
                ...
                invalid' : 'decorative-input inspectletIgnore name-mail name-icon input_new', 'placeholder' =>
            ...
            <div class="control-group" id="inputPassword">
              ...
              @endif
              <div class="d-flex align-items-center justify-content-center">
                {!! Form::password('password', ['class' => $errors->has('password') ? 'decorative-input inspectletIgnore
                invalid' : 'decorative-input inspectletIgnore name-pwd name-icon input_new', 'placeholder' =>
            ...
            {!! Form::submit( trans('messages.header.signup'), ['class' => 'my-3 d-flex justify-content-center btn-blue
            btn-blue--radius' , 'id' => 'user-signup-btn', 'ng-disabled' => '!agree_toc']) !!}
            {!! Form::close() !!}

            <div class="form-footer mt-3 pt-3 text-center">
              {{ trans('messages.login.already_an') }} {{ $site_name }} {{ trans('messages.login.member') }}
              <a href="javascript:void(0)" class="login-open green-link" data-toggle="modal"
                data-target="#signup-popup2">
                {{ trans('messages.header.login') }}
              </a>
            </div>
          </div>
