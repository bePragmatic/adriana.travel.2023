...
<div class="subnav hide-print" ng-cloak>
  <div class="container">
    <ul class="subnav-list d-flex text-nowrap">
      ...
      <li>
        <a href="{{ url('rooms') }}" aria-selected="{{(Route::current()->uri() == 'rooms') ? 'true' : 'false'}}" class="subnav-item">
...
{{--     TODO: ZAKOMENTIRANO
 <li>
        <a href="{{ url('my_reservations') }}" aria-selected="{{( Route::current()->uri() == 'my_reservations') ? 'true' : 'false'}}" class="subnav-item">
