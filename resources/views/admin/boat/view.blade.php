      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Boat Management</h3>
            @if(Auth::guard('admin')->user()->can('add_boat'))
            <div style="float:right;"><a class="btn btn-success" href="{{ url(ADMIN_URL.'/add_boat') }}">Add Boat</a></div>
            @endif
