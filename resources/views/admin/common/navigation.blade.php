    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        @if(Auth::guard('admin')->user()->can('users'))
          <li class="{{ (Route::currentRouteName() == 'users') ? 'active' : ''  }}"><a href="{{ route('users') }}"><i class="fa fa-users"></i><span>Users</span></a></li>
        @endif

        @if(Auth::guard('admin')->user()->can('rooms'))
          <li class="{{ (Route::currentRouteName() == 'rooms') ? 'active' : ''  }}"><a href="{{ route('rooms') }}"><i class="fa fa-home"></i><span>Rooms</span></a></li>
        @endif
        @if(Auth::guard('admin')->user()->can('manage_boat_price'))
          <li class="{{ (Route::currentRouteName() == 'manage_boat_price') ? 'active' : ''  }}"><a href="{{ route('manage_boat_price') }}"><i class="fa fa-home"></i><span>Manage Boat Price</span></a></li>
        @endif
       

        @if(Auth::guard('admin')->user()->can('boat_booking'))
          <li class="{{ (Route::currentRouteName() == 'boat_booking') ? 'active' : ''  }}"><a href="{{ route('boat_booking') }}"><i class="fa fa-home"></i><span> Boat Booking</span></a></li>
        @endif

        @if(Auth::guard('admin')->user()->can('boat_booking_info'))
          <li class="{{ (Route::currentRouteName() == 'boat_booking_info') ? 'active' : ''  }}"><a href="{{ route('boat_booking_info') }}"><i class="fa fa-home"></i><span> Boat Booking Info</span></a></li>
        @endif
        ...
        @if(Auth::guard('admin')->user()->can('manage_disputes'))
          <li class="{{ (Route::currentRouteName() == 'disputes') ? 'active' : ''  }}"><a href="{{ route('disputes') }}"><i class="fa fa-hand-peace-o"></i><span>Disputes</span></a></li>
        @endif
        ...
        @if(Auth::guard('admin')->user()->can('email_settings') || Auth::guard('admin')->user()->can('send_email'))
          ...
          <a href="#">
            <i class="fa fa-envelope-o"></i> <span>Emails</span><i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
        ...
        @if(Auth::guard('admin'))
          <li class="{{ (Route::currentRouteName() == 'posts') ? 'active' : ''  }}"><a href="{{ route('posts.index') }}"><i class="fa fa-eye"></i><span>Posts</span></a></li>
        @endif
        ...
        @if(Auth::guard('admin')->user()->can('manage_coupon_code'))
          <li class="{{ (Route::currentRouteName() == 'coupon_code') ? 'active' : ''  }}"><a href="{{ route('coupon_code') }}"><i class="fa fa-ticket"></i><span>Coupon Code</span></a></li>
        @endif
        ...
        @if(Auth::guard('admin')->user()->can('manage_home_cities'))
          <li class="{{ (Route::currentRouteName() == 'home_cities') ? 'active' : ''  }}"><a href="{{ route('home_cities') }}"><i class="fa fa-globe"></i><span>Home Cities</span></a></li>
        @endif

        @if(Auth::guard('admin')->user()->can('manage_home_sliders'))
          <li class="{{ (Route::currentRouteName() == 'homepage_sliders') ? 'active' : ''  }}"><a href="{{ route('homepage_sliders') }}"><i class="fa fa-image"></i><span>Home Sliders</span></a></li>
        @endif

        @if(Auth::guard('admin')->user()->can('manage_login_sliders'))
          <li class="{{ (Route::currentRouteName() == 'slider') ? 'active' : ''  }}"><a href="{{ route('slider') }}"><i class="fa fa-image"></i><span>Login Sliders</span></a></li>
        @endif

        @if(Auth::guard('admin')->user()->can('manage_our_community_banners'))
          <li class="{{ (Route::currentRouteName() == 'our_community_banners') ? 'active' : ''  }}"><a href="{{ route('our_community_banners') }}"><i class="fa fa-image"></i><span>Our Communities</span></a></li>
        @endif
        ...
        @if(Auth::guard('admin')->user()->can('manage_amenities'))
          ...
          <a href="#">
            <i class="fa fa-bullseye"></i> <span>Amenities</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
        ...
        @if(Auth::guard('admin')->user()->can('manage_property_type'))
          <li class="{{ (Route::currentRouteName() == 'property_type') ? 'active' : ''  }}"><a href="{{ route('property_type') }}"><i class="fa fa-building"></i><span>Property Type</span></a></li>
        @endif

        @if(Auth::guard('admin')->user()->can('manage_room_type'))
          <li class="{{ (Route::currentRouteName() == 'room_type') ? 'active' : ''  }}"><a href="{{ route('room_type') }}"><i class="fa fa-home"></i><span>Room Type</span></a></li>
        @endif

        @if(Auth::guard('admin')->user()->can('manage_bed_type'))
          <li class="{{ (Route::currentRouteName() == 'bed_type') ? 'active' : ''  }}"><a href="{{ route('bed_type') }}"><i class="fa fa-hotel"></i><span>Bed Type</span></a></li>
        @endif

        @if(Auth::guard('admin')->user()->can('manage_pages'))
          <li class="{{ (Route::currentRouteName() == 'pages') ? 'active' : ''  }}"><a href="{{ route('pages') }}"><i class="fa fa-newspaper-o"></i><span>Static Pages</span></a></li>
        @endif

        @if(Auth::guard('admin')->user()->can('manage_currency'))
          <li class="{{ (Route::currentRouteName() == 'currency') ? 'active' : ''  }}"><a href="{{ route('currency') }}"><i class="fa fa-dollar"></i><span>Currency</span></a></li>
        @endif

        @if(Auth::guard('admin')->user()->can('manage_language'))
          <li class="{{ (Route::currentRouteName() == 'language') ? 'active' : ''  }}"><a href="{{ route('language') }}"><i class="fa fa-language"></i><span>Language</span></a></li>
        @endif

        @if(Auth::guard('admin')->user()->can('manage_country'))
          <li class="{{ (Route::currentRouteName() == 'country') ? 'active' : ''  }}"><a href="{{ route('country') }}"><i class="fa fa-globe"></i><span>Country</span></a></li>
        @endif

        @if(Auth::guard('admin')->user()->can('manage_referral_settings'))
          <li class="{{ (Route::currentRouteName() == 'referral_settings') ? 'active' : ''  }}"><a href="{{ route('referral_settings') }}"><i class="fa fa-users"></i><span>Referrals Settings</span></a></li>
        @endif

        @if(Auth::guard('admin')->user()->can('manage_fees'))
          <li class="{{ (Route::currentRouteName() == 'fees') ? 'active' : ''  }}"><a href="{{ route('fees') }}"><i class="fa fa-dollar"></i><span>Fees</span></a></li>
        @endif

        @if(Auth::guard('admin')->user()->can('manage_metas'))
          <li class="{{ (Route::currentRouteName() == 'metas') ? 'active' : ''  }}"><a href="{{ route('metas') }}"><i class="fa fa-bar-chart"></i><span>Metas</span></a></li>
        @endif
