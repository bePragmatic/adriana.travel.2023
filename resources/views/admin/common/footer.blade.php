<div class="modal fade" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-target="#confirm-delete">
...
<footer class="main-footer">
    ...
    <strong>Developed by <a href="">Tempus media d.o.o.</a>.</strong> All rights
    reserved. &copy; {{ date('Y') }}
</footer>
