    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-info">
          ...
          <div class="box-body" ng-cloak>
            ...
            <div id="sf8" class="frm" data-step-name="Pricing">
			 ...
			 <div id="sf9" class="frm" data-step-name="Price pr day">
       ...
       <div class="price_records_dynamic"></div>
            ...
            <div id="sf10" class="frm" data-step-name="Booking Type">
              <fieldset class="box-body">
                <div class="form-group">
            ...
            <div id="sf11" class="frm" data-step-name="Terms">
              <fieldset class="box-body">
                <div class="form-group">
            ...
            <div id="sf12" class="frm" data-step-name="User">
              <fieldset class="box-body">
                <div class="form-group">
            ...
            <div id="sf13" class="frm" data-step-name="Price Rules">
              <fieldset class="box-body">
            ...
            <div id="sf14" class="frm" data-step-name="Availability Rules">
              <fieldset class="box-body">
