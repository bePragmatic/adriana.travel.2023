      ...
      <div class="col-md-12">
        ...
        <div class="box box-info">
          ...
          <div class="box-header with-border">
			...
			<a href="javascript:void(0);" class="btn btn-warning tab_btn" id="tab_btn_13" ng-click="go_to_edit_step(13)">
              Day Pricing
            </a>
            <a href="javascript:void(0);" class="btn btn-warning tab_btn" id="tab_btn_12" ng-click="go_to_edit_step(12)">
              Availability Rules
            </a>
           {{-- TODO: ZAKOMENTIRANO <a href="javascript:void(0);" class="btn btn-warning tab_btn" id="tab_btn_11" ng-click="go_to_edit_step(11)">
              Price Rules
            </a>
            <a href="javascript:void(0);" class="btn btn-warning tab_btn" id="tab_btn_12" ng-click="go_to_edit_step(12)">
              Availability Rules
...
<div id="sf3" class="frm">
  ...
  <fieldset class="box-body">
    ...
    <div class="form-group"  id="app">
     ...
     <room-subname-edit :data="{{ $result }}"></room-subname-edit>
    </div>
    <div class="form-group">
...
<div id="sf13" class="frm">
  ...
  <fieldset class="box-body">
    <div class="table-responsive">
       <table class="table dataTable no-footer" id="dataTableBuilder" role="grid" style="width: 1048px;">
        <thead>
          <tr role="row">
           <th title="From Date" class="sortings" tabindex="0"  rowspan="1" colspan="1" style="width: 105px;">From Date</th>
           <th title="To Date" class="sortings" tabindex="0"  rowspan="1" colspan="1" style="width: 82px;">To Date</th>
		   <th title="Price" class="sortings" tabindex="0"  rowspan="1" colspan="1" style="width: 82px;">Price</th>
           <th title="Action" class="sorting_disabled" rowspan="1" colspan="1" style="width: 71px;" aria-label="Action">Action</th>
          </tr>
        </thead>
        <tbody>
		@foreach($price_pr_day as $price_pr_day)
          <tr role="row" class="odd">
            <td class="sorting_1">
              <span class="notranslate">
			  @if($price_pr_day)
			    {{$price_pr_day->from_date}}
		      @endif
			  </span>
            </td>
            <td>
            ...
            <td>
			  @if($price_pr_day)
			   <a data-toggle="modal" id="smallButton" data-target="#smallModal" class="btn btn-xs btn-primary" data-attr="{{ route('admin.prday_price', $price_pr_day->id) }}"><i class="glyphicon glyphicon-edit"></i></a>&nbsp;
			   <a id="deleteButton" data-attr="{{ route('admin.deleteday_price', $price_pr_day->id) }}" class="btn btn-xs btn-primary confirm-delete" data-toggle="modal" data-target="#confirm-delete"><i class="glyphicon glyphicon-trash"></i></a>
		      @endif
			 </td>
			</tr>
			@endforeach
...
<div id="addPrDayPrice">
<p class="text-danger" id="price-data"></p>
 <fieldset class="box-body">
		<div class="row price-row">
		 ...
		 <div class="price_records">
		  <div class="input-holder">
           <input name="from_date[]" type="date" value="" class="form-control duplicate-check" id="sfrom_date">
		  </div>
		  <div class="input-holder">
           <input name="to_date[]" type="date" value="" class="form-control duplicate-check" id="sto_date">
		  </div>
		  <div class="input-holder">
          <input name="price[]" type="number" value="" class="form-control duplicate-check" id="sprice">
		  </div>
          <a class="extra-fields-price" href="#">Add More Fields</a>
        </div>
		<div class="price_records_dynamic"></div>
		</div>
		<div class="box-footer">
    <a href="{{url(ADMIN_URL.'/rooms')}}" class="btn btn-default cancel" >
      Cancel
    </a>
    <button class="btn btn-info pull-right" type="submit" name="submit" value="pricePrDay">
      Submit
    </button>
  </div>
		</fieldset>
...
<div class="mainPrDayPrice">
<div class="removePrDayPrice">
<a id="removePrDayPrice" href="javascript:void(0);" ng-click="addNewRow()">
      Remove
</a>
</div>
<div class="pull-right-button">
<a class="pull-right-button" href="javascript:void(0);" ng-click="addNewRow()">
      Add Room Rate
</a>
</div>
</div>
...
<div id="sf8" class="frm">
  ...
  <fieldset class="box-body">
    @php
      $night_array = json_decode($result->rooms_price->original_night ,true);
      // dd($night_array['january']);
    @endphp
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        {!! Form::text('night', $night_array['january'], ['class' => 'form-control', 'id' => 'night', 'placeholder' => '']) !!}
        <span id="price_wrong_message" class="text-danger">
        </span>
      </div>
    </div>
    <div class="form-group">
      <label for="night_april" class="col-sm-3 control-label">
        April Night
        <em class="text-danger">
          *
        </em>
      ...
      <div class="col-sm-6">
        {!! Form::text('night_april', $night_array['april'], ['class' => 'form-control', 'id' => 'night_april', 'placeholder' => '']) !!}
        <span id="price_wrong_message" class="text-danger">
        </span>
      </div>
    </div>
    ...
    <div class="form-group">
      <label for="night_may" class="col-sm-3 control-label">
        May Night
        <em class="text-danger">
          *
        </em>
      ...
      <div class="col-sm-6">
        {!! Form::text('night_may', $night_array['may'], ['class' => 'form-control', 'id' => 'night_may', 'placeholder' => '']) !!}
        <span id="price_wrong_message" class="text-danger">
        </span>
      </div>
    </div>
    ...
    <div class="form-group">
      <label for="night_june" class="col-sm-3 control-label">
        June Night
        <em class="text-danger">
          *
        </em>
      ...
      <div class="col-sm-6">
        {!! Form::text('night_june', $night_array['june'], ['class' => 'form-control', 'id' => 'night_june', 'placeholder' => '']) !!}
        <span id="price_wrong_message" class="text-danger">
        </span>
      </div>
    </div>
    ...
    <div class="form-group">
      <label for="night_july" class="col-sm-3 control-label">
        July Night
        <em class="text-danger">
          *
        </em>
      ...
      <div class="col-sm-6">
        {!! Form::text('night_july', $night_array['july'], ['class' => 'form-control', 'id' => 'night_july', 'placeholder' => '']) !!}
        <span id="price_wrong_message" class="text-danger">
        </span>
      </div>
    </div>
    ...
    <div class="form-group">
      <label for="night_august" class="col-sm-3 control-label">
        August Night
        <em class="text-danger">
          *
        </em>
      ...
      <div class="col-sm-6">
        {!! Form::text('night_august', $night_array['august'], ['class' => 'form-control', 'id' => 'night_august', 'placeholder' => '']) !!}
        <span id="price_wrong_message" class="text-danger">
        </span>
      </div>
    </div>
    ...
    <div class="form-group">
      <label for="night_september" class="col-sm-3 control-label">
        September Night
        <em class="text-danger">
          *
        </em>
      ...
      <div class="col-sm-6">
        {!! Form::text('night_september',$night_array['september'], ['class' => 'form-control', 'id' => 'night_september', 'placeholder' => '']) !!}
        <span id="price_wrong_message" class="text-danger">
        </span>
      </div>
    </div>
    ...
    <div class="form-group">
      <label for="night_october" class="col-sm-3 control-label">
        October Night
        <em class="text-danger">
          *
        </em>
      ...
      <div class="col-sm-6">
        {!! Form::text('night_october', $night_array['october'], ['class' => 'form-control', 'id' => 'night_october', 'placeholder' => '']) !!}
        <span id="price_wrong_message" class="text-danger">
        </span>
      </div>
    </div>
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="stop" data-dismiss="modal" aria-label="Close">
