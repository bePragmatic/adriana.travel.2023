...
<div>
    ...
    <div class="component">
        <boat-calculator token="{{ csrf_token() }}" boat_type="Futurama" screen="desktop" class="calender--setting"></boat-calculator>
        <div class="new">
                ...
                <div class="accommodation__list padding__bottom__0 padding__top__0">
                    <section class="services__wrapper">
                        <div class="accommodation__list">
                            ...
                            <div class="services-box--item services-box--item-img-grid"
                                >
                                <div  >
                                    <img src=" ./assets/boatcube.jpg" class="border-radius--16"
                                        style="width: 100%;">
                                </div>
                                <div class="transfer-svg-init" style="flex-direction: column;">
                                    ...
                                    <p>
                                        @lang('messages.services-activities.it_is_situated_in_the_beautiful_bay_between')
                                        @lang('messages.services-activities.if_you_dont_have_any_nautical_knowledge')
                                        @lang('messages.services-activities.if_you_have_any_other_questions')
                                        @lang('messages.services-activities.hope_to_see_you_soon')
                                    </p>
                                </div>
                            </div>
                                ...
                                <div class="transfer-box--item">
                                    ...
                                    <div
                                        ...
                                        <p
                                            ...
                                            220,00 € @lang('messages.services-activities.per_day')
                                        </p>
                                        <p
                                            class="t-zeta t-bold padding__top__xs padding__bottom__xs homepage-element__subtitle">
                                            {{-- @lang('messages.services-activities.rent_a_boat') --}}
                                            140 ,00 € @lang('messages.services-activities.half_day')
                                        </p>
                                ...
                                <div class="transfer-box--item">
                                    ...
                                    <div
                                        ...
                                        <p
                                            ...
                                            199,00 € @lang('messages.services-activities.per_day')
                                        </p>
                                        <p
                                            class="t-zeta t-bold padding__top__xs padding__bottom__xs homepage-element__subtitle">
                                            {{-- @lang('messages.services-activities.minivan_tours') --}}
                                            120,00 € @lang('messages.services-activities.half_day')
                                        </p>
                                        <div class="transfer__maxwidth">
                                            <p class="t-eta services__blue">
                                                @lang('messages.services-activities.june_september')
                                            </p>
                                ...
                                <div class="transfer-box--item">
                                    ...
                                    <div
                                        ...
                                        <p
                                            class="t-zeta t-bold padding__top__xs padding__bottom__xs homepage-element__subtitle">
                                            {{-- @lang('messages.services-activities.minivan_tours') --}}
                                            110,00 € @lang('messages.services-activities.per_day')
                                        </p>
                                        <div class="transfer__maxwidth">
                                            <p class="t-eta services__blue">
                                                @lang('messages.services-activities.may_october')
                                            </p>
                    ...
                    <div>
                        <sac-carousel>
                            <div class="pts-element">
                                <img class="border-radius--12" src="{{ asset('/assets/boat01.jpg') }}" />
                            </div>
                            <div class="pts-element">
                                <img class="border-radius--12" src="{{ asset('/assets/boat02.jpg') }}" />
                            </div>
                            <div class="pts-element">
                                <img class="border-radius--12" src="{{ asset('/assets/boat03.jpg') }}" />
                            </div>
                            <div class="pts-element">
                                <img class="border-radius--12" src="{{ asset('/assets/boat04.jpg') }}" />
                            </div>
    ...
    <div class="wrapper wrapper--sml-rounded wrapper-service  main-div">
                    ...
                    <section id="global-review" class="globalReviewComp">
                        ...
                        <div class="globalReviewComp__criteriaContainer">
                            ...
                            <div class="globalReviewComp__criteriaAvg">
                                <div class="globalReviewComp__criteriaLabel">
                                    {{trans('messages.feedback.compliance_of_the_boat')}}</div>
                                <div class="globalReviewComp__criteriaStars">
                                    <div class="newRatingStarsContainer--medium">
                                        {!! str_repeat('<i class="fa fa-star checked"></i>',
                                        ceil(round($ratings->avg('compliance_of_the_boat'), 1))) !!}
                            ...
                            <div class="globalReviewComp__criteriaAvg">
                                <div class="globalReviewComp__criteriaLabel">
                                    {{trans('messages.feedback.comfort_on_board')}}</div>
                                <div class="globalReviewComp__criteriaStars">
                                    <div class="newRatingStarsContainer--medium">
                                        {!! str_repeat('<i class="fa fa-star checked"></i>',
                                        ceil(round($ratings->avg('comfort_on_board'), 1))) !!}
                                        {!! str_repeat('<i class="fa fa-star-o" aria-hidden="true"></i>', 5 -
                                        ceil(round($ratings->avg('comfort_on_board'), 1))) !!}
                                    </div>
                                </div>
                            ...
                            <div class="globalReviewComp__criteriaAvg">
                                <div class="globalReviewComp__criteriaLabel">
                                    {{trans('messages.feedback.standard_of_maintenance')}}</div>
                                <div class="globalReviewComp__criteriaStars">
                                    <div class="newRatingStarsContainer--medium">
                                        {!! str_repeat('<i class="fa fa-star checked"></i>',
                                        ceil(round($ratings->avg('standard_of_maintenance'), 1))) !!}
                                        {!! str_repeat('<i class="fa fa-star-o" aria-hidden="true"></i>', 5 -
                                        ceil(round($ratings->avg('standard_of_maintenance'), 1))) !!}
                                    </div>
                                </div>
                            ...
                            <div class="globalReviewComp__criteriaAvg">
                                <div class="globalReviewComp__criteriaLabel">{{trans('messages.feedback.cleanliness')}}
                                </div>
                                <div class="globalReviewComp__criteriaStars">
                                    <div class="newRatingStarsContainer--medium">
                                        {!! str_repeat('<i class="fa fa-star checked"></i>',
                                        ceil(round($ratings->avg('cleanliness'), 1))) !!}
                                        {!! str_repeat('<i class="fa fa-star-o" aria-hidden="true"></i>', 5 -
                                        ceil(round($ratings->avg('cleanliness'), 1))) !!}
                                    </div>
                                </div>
                            ...
                            <div class="globalReviewComp__criteriaAvg">
                                <div class="globalReviewComp__criteriaLabel">
                                    {{trans('messages.feedback.welcome_and_communication')}}</div>
                                <div class="globalReviewComp__criteriaStars">
                                    <div class="newRatingStarsContainer--medium">
                                        {!! str_repeat('<i class="fa fa-star checked"></i>',
                                        ceil(round($ratings->avg('welcome_and_communication'), 1))) !!}
                                        {!! str_repeat('<i class="fa fa-star-o" aria-hidden="true"></i>', 5 -
                                        ceil(round($ratings->avg('welcome_and_communication'), 1))) !!}
                                    </div>
                                </div>
                            ...
                            <div class="globalReviewComp__criteriaAvg">
                                <div class="globalReviewComp__criteriaLabel">
                                    {{trans('messages.feedback.value_for_money')}}</div>
                                <div class="globalReviewComp__criteriaStars">
                                    <div class="newRatingStarsContainer--medium">
                                        {!! str_repeat('<i class="fa fa-star checked"></i>',
                                        ceil(round($ratings->avg('value_for_money'), 1))) !!}
                                        {!! str_repeat('<i class="fa fa-star-o" aria-hidden="true"></i>', 5 -
                                        ceil(round($ratings->avg('value_for_money'), 1))) !!}
                                    </div>
                                </div>
                                ...
                                <div class="reviewComp__infosContainer">
                                    <div class="reviewComp__userInfos">
                                        <div class="reviewComp__imgContainer">
                                            <img class="reviewComp__img" src="{{asset('images/user_pic-50x50.png')}}"
                                                alt="{{$rating->name}}">
                                        </div>
                ...
                <section class="productView__block second-div">
                    <form method="POST" action="{{route('ratings')}}">
                        @csrf
                        <input type="hidden" name="boat" value="one">
                        <div>
                        ...
                        <div class="field">
                            <div class="stars">
                                <div class="globalReviewComp__criteriaLabel">
                                    {{trans('messages.feedback.compliance_of_the_boat')}}</div>
                                <div id="wrapper">
                                    <input type="radio" name="compliance_of_the_boat" value="5"
                                        id="compliance_of_the_boat1">
                                    <label for="compliance_of_the_boat1"></label>
                                    <input type="radio" name="compliance_of_the_boat" value="4"
                                        id="compliance_of_the_boat2">
                                    <label for="compliance_of_the_boat2"></label>
                                    <input type="radio" name="compliance_of_the_boat" value="3"
                                        id="compliance_of_the_boat3">
                                    <label for="compliance_of_the_boat3"></label>
                                    <input type="radio" name="compliance_of_the_boat" value="2"
                                        id="compliance_of_the_boat4">
                                    <label for="compliance_of_the_boat4"></label>
                                    <input type="radio" name="compliance_of_the_boat" value="1"
                                        id="compliance_of_the_boat5" checked>
                            ...
                            <div class="stars">
                                ...
                                <div id="wrapper">
                                    ...
                                    <input type="radio" name="comfort_on_board" value="1" id="comfort_on_board5"
                                        checked>
                            ...
                            <div class="stars">
                                <div class="globalReviewComp__criteriaLabel">
                                    {{trans('messages.feedback.standard_of_maintenance')}}</div>
                                <div id="wrapper">
                                    <input type="radio" name="standard_of_maintenance" value="5"
                                        id="standard_of_maintenance1">
                                    <label for="standard_of_maintenance1"></label>
                                    <input type="radio" name="standard_of_maintenance" value="4"
                                        id="standard_of_maintenance2">
                                    <label for="standard_of_maintenance2"></label>
                                    <input type="radio" name="standard_of_maintenance" value="3"
                                        id="standard_of_maintenance3">
                                    <label for="standard_of_maintenance3"></label>
                                    <input type="radio" name="standard_of_maintenance" value="2"
                                        id="standard_of_maintenance4">
                                    <label for="standard_of_maintenance4"></label>
                                    <input type="radio" name="standard_of_maintenance" value="1"
                                        id="standard_of_maintenance5" checked>
                            ...
                            <div class="stars">
                                <div class="globalReviewComp__criteriaLabel">
                                    {{trans('messages.feedback.welcome_and_communication')}}</div>
                                <div id="wrapper">
                                    <input type="radio" name="welcome_and_communication" value="5"
                                        id="welcome_and_communication1">
                                    <label for="welcome_and_communication1"></label>
                                    <input type="radio" name="welcome_and_communication" value="4"
                                        id="welcome_and_communication2">
                                    <label for="welcome_and_communication2"></label>
                                    <input type="radio" name="welcome_and_communication" value="3"
                                        id="welcome_and_communication3">
                                    <label for="welcome_and_communication3"></label>
                                    <input type="radio" name="welcome_and_communication" value="2"
                                        id="welcome_and_communication4">
                                    <label for="welcome_and_communication4"></label>
                                    <input type="radio" name="welcome_and_communication" value="1"
                                        id="welcome_and_communication5" checked>
...
$(document).ready(function() {
    ...
    $("#boat_calendar").change(function() {

        var boat_data = $("#guest_no").val();
        $('#half_day_price').val(" ");
        $('#full_day_price').val(" ");

        $.ajax({
            /* the route pointing to the post function */
            url: '/rent-a-boat-form',
            type: 'POST',
            /* send the csrf-token and the input to the controller */
            data: {
                _token: CSRF_TOKEN,
                date: $(this).val(),
                boat_persons: boat_data
            },
            dataType: 'JSON',
            ...
            success: function(response) {
                ...
                $('#half_day_price').val(response[0].half_day_price);
                $('#full_day_price').val(response[0].full_day_price);
