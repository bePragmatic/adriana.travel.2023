    ...
    <div class="payment-hero">
        ...
        <div class="wrapper payment-header__props">
            <h1 class="payment-header__title accommodation__header__title">
                ...
                @lang('messages.rooms.title_test')
            </h1>
                        ...
                        <ul class="list__props filter color_000 o-80 padding__bottom__custom">
                            <li>
                                <div class="homepage__row__container space__between">
                                    ...
                                    <p>
                                        @if($reservation_id!='')
                                        <a href="{{ url('home/cancellation_policies#').strtolower($cancellation) }}"
                            ...
                            <li>
                                ...
                                <div class="homepage__row__container space__between">
                                    ...
                                    <p class="t-eta t-bold">
                                        <span>
                                            {{ number_format($price_list->total_night_price, 2) }}
                            ...
                            <li>
                                ...
                                <div class="homepage__row__container space__between">
                                    ...
                                    <p class="t-eta t-bold">
                                        -
                                        <span>
                                            {{ number_format($price_list->booked_period_discount_price,2) }}
                                        </span>
                                        <span>
                                            @if(Session::get('get_token')!='')
                                            {{ html_string(Session::get('currency_symbol')) }}
                            ...
                            <li>
                                ...
                                <div class="homepage__row__container space__between">
                                    ...
                                    <p class="t-eta t-bold">
                                        ...
                                        <span>
                                            {{number_format($price_list->length_of_stay_discount_price, 2) }}
                                        </span>
                            ...
                            <li>
                                ...
                                <div class="homepage__row__container space__between">
                                    ...
                                    <p class="t-eta t-bold">
                                        ...
                                        <span>
                                            {{ number_format($price_list->service_fee, 2)}}
                                        </span>
                            ...
                            <li>
                                ...
                                <div class="homepage__row__container space__between">
                                    ...
                                    <p class="t-eta t-bold">
                                        ...
                                        <span>
                                            {{ number_format($price_list->additional_guest ,2 )}}
                                        </span>
                                        <span>
                                            @if(Session::get('get_token')!='')
                                            {{ html_string(Session::get('currency_symbol')) }}
                            ...
                            <li>
                                ...
                                <div class="homepage__row__container space__between">
                                    ...
                                    <p class="t-eta t-bold">
                                        ...
                                        <span>
                                            {{ number_format($price_list->cleaning_fee,2) }}
                                        </span>
                                        <span>
                                            @if(Session::get('get_token')!='')
                                            {{ html_string(Session::get('currency_symbol')) }}
...
{{ trans('messages.your_reservations.cancel') }}
                        ...
                        <ul class="list__props filter padding__bottom__custom">
                            <li>
                                ...
                                <div
                                    ...
                                    <p>
                                        ...
                                        <span id="payment_total">
                                            {{ number_format($price_list->total, 2)}}
                                        </span>
                                        <span>
                                            @if(Session::get('get_token')!='')
                                            {{ html_string(Session::get('currency_symbol')) }}
                                ...
                                @if(@$special_offer_id =='' || @$special_offer_type == 'pre-approval')
                                <div class="homepage__row__container space__between filter">
                                    <p class="t-eta o-80">
                                        {{ trans('messages.payments.security_deposit') }}
                                    </p>
                                    <p class="t-eta t-bold o-80">
                                        <span>
                                            {{ $price_list->security_fee }}
                                        </span>
                                        <span>
                                            @if(Session::get('get_token')!='')
                                            {{ html_string(Session::get('currency_symbol')) }}
                                ...
                                @endif
                                @endif
                                <div class="homepage__row__container space__between padding__top__1">
                                    <p class="text__footnote o-40">
                                        ...
                                        <span id="fx-messaging">
                                            ...
                                            {{ $result->rooms_price->currency_code }}
...
{{ trans('messages.your_reservations.cancel') }}
                ...
                <div class="container">
                    ...
                    {{ $price_list->base_rooms_price }} x {{ $nights }}
                    {{ trans_choice('messages.rooms.night',$nights) }}
...
<script type="text/javascript">
    window.dataLayer.push({
            ...
            'nights': "{!! $nights !!}",
            'price': "{!!  number_format($price_list->total, 2) !!}"
        });
</script>
