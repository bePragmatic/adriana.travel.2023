...
<div style="margin:0;padding:0;font-family:&quot;Helvetica Neue&quot;,&quot;Helvetica&quot;,Helvetica,Arial,sans-serif">
    {{ trans('messages.email.status_payouts',[], null, $locale) }} <a href="{{ $url.('users/transaction_history') }}" style="margin:0;padding:0;font-family:&quot;Helvetica Neue&quot;,&quot;Helvetica&quot;,Helvetica,Arial,sans-serif;color:#10304c;text-decoration:none" target="_blank">{{ trans('messages.header.transaction_history') }}</a>.
