...
@section('emails.main')
@php
 $link = '<a href="'.$url.'admin/rooms" style="margin:0;padding:0;font-family:&quot;Helvetica Neue&quot;,&quot;Helvetica&quot;,Helvetica,Arial,sans-serif;color:#10304c;text-decoration:none" target="_blank"> '.$result['name'].' </a>'
@endphp
