                ...
                <li>
                  ...
                  <div class="row">
                    <div class="col-12 col-md-7 document_upload-btn mt-2 mt-md-0">
                      ...
                      <button class="upload_btn" onclick="$('#id_document').trigger('click');"> {{ trans('messages.profile.upload_document') }} <i class="fa fa-cloud-upload" aria-hidden="true"></i>
                    ...
                    <div class="col-12 col-md-5 document_status-btn mt-3 mt-md-0" ng-show="id_verification_status != 'Connect'">
                      <button class="pending_btn verification-pending__btn">
                       @{{id_verification_status}}
                     </button>
                   </div>
