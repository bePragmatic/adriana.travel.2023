...
jQuery(document).ready(function(){
	jQuery(document).on('click', '#smallButton', function(event) {
            event.preventDefault();
			jQuery('p.text-danger.delete').hide();
			...
			jQuery.ajax({
                ...
                success: function(result) {
                    jQuery('#smallBody').html(result.html).show();
		...
		jQuery(document).on('click', '#deleteButton', function(event) {
			...
			jQuery.ajax({
                url: href,
                success: function(result) {
                  jQuery('p.text-danger.delete').show();
    ...
    jQuery(document).on('click', '.save_pass', function(event) { 
            event.preventDefault();
			let href = jQuery('.save_pass').attr('data');
			let formData = jQuery('#fromDate').val();
			let toData = jQuery('#toDate').val();
			let price = jQuery('#price').val();
			let room_id = jQuery('#room_id').val();
			jQuery.ajax({
                url: href,
				data:{ 
				formData : formData,
                ...
                success: function(data) {
				   ...
				   jQuery('.alert.alert-danger').html(data.errors);
				   }
				   if(data.success){
				   jQuery('.alert.alert-danger').hide();
                   jQuery('.alert.alert-success').show();
				   jQuery('.alert.alert-success').html(data.success);
		...
		jQuery('#addPrDayPrice').hide();
		jQuery('#removePrDayPrice').hide();
            jQuery('.pull-right-button').click(function() {
		    jQuery('#removePrDayPrice').show();
            jQuery('#addPrDayPrice').show();
           });
		   jQuery('#removePrDayPrice').click(function() {
			   jQuery('#addPrDayPrice').hide();
			   jQuery('#removePrDayPrice').hide();
		   });
    });
