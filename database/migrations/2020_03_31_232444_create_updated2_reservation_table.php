...
class CreateUpdated2ReservationTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('reservation', function (Blueprint $table) {
            ...
            $table->enum('status', ['Pending', 'Accepted', 'Declined', 'Expired', 'Checkin', 'Checkout', 'Completed', 'Cancelled', 'Pre-Accepted', 'Pre-Approved', 'Deposit'])->nullable();
