...
class AdminTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('admin')->insert([
            array('id' => '1', 'username' => 'admin', 'email' => 'admin@tempusmedia.hr', 'password' => '$2y$10$IzcIdUEq9arWkv7ASfC3huBwAXWuIpaE18rW0ThBnxLmzCdl1Ix8.', 'remember_token' => NULL, 'status' => 'Active', 'created_at' => '2016-04-17 05:30:00', 'updated_at' => NULL),
            array('id' => '2', 'username' => 'subadmin', 'email' => 'subadmin@tempusmedia.hr', 'password' => '$2y$10$gRH0KTG1rq18thHPriBI6uajMW/uGlyCwi2TU4IF/68x02TcKxIRy', 'remember_token' => NULL, 'status' => 'Active', 'created_at' => '2016-04-17 05:30:00', 'updated_at' => NULL),
            array('id' => '3', 'username' => 'accountant', 'email' => 'accountant@tempusmedia.hr', 'password' => '$2y$10$ih76FCSfMmNyiPblzhv00.zrVS0ZYnRyUfL2NMICTvTCVBHcKnP1W', 'remember_token' => NULL, 'status' => 'Active', 'created_at' => '2016-04-17 05:30:00', 'updated_at' => NULL)
        ]);
