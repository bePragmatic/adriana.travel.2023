...
class BoatingController extends Controller
{
 ...
 /* $data['checkin'] = date('m/d/Y', $this->helper->custom_strtotime($request->checkin));
   ...
   echo $data['checkin']; 
   echo $data['formatted_checkin'];    
   $data=Boat::where('from_date', $data['checkin']); 
   echo "<pre>";
  // print_r($data);
   ...
   die;   */
     ...
     //   return $data;
        return view('rogoznica.view_boating', $data);
    ...
    public function price_calculation(Request $request)
    {
       ...
       // $this->forgetCoupon();
        ...
        return $this->payment_helper->price_calculation( $request->checkin, $request->checkout, $request->guest_count ,'',$request->change_reservation);
    }
