 ...
 * Generated for Laravel 5.8.37 on 2020-02-18 20:06:08.
 *
...
namespace Collective\Html { 
    ...
    class FormFacade {
         ...
         * @static 
         */ 
        public static function selectRangeWithDefault($name, $start, $end, $selected = null, $default = null, $attributes = [])
        {
                        return \Collective\Html\FormBuilder::selectRangeWithDefault($name, $start, $end, $selected, $default, $attributes);
        }
         ...
         * @static 
         */ 
        public static function selectMonthWithDefault($name, $selected = null, $default = null, $options = [], $format = '%B')
        {
                        return \Collective\Html\FormBuilder::selectMonthWithDefault($name, $selected, $default, $options, $format);
        }
...
namespace JD\Cloudder\Facades { 
    ...
    class Cloudder {
         ...
         * @static 
         */ 
        public static function resourcesByIds($options = [])
        {
                        /** @var \JD\Cloudder\CloudinaryWrapper $instance */
                        return $instance->resourcesByIds($options);
        }
...
namespace  { 
    ...
    class Helpers extends \App\Http\Start\Helpers {}
